# LocalAssistant - Audio Fix & Production Audit Summary
...
1. ⚠️ **Database Migrations** - No strategy for schema changes
2. ⚠️ **Download Resume** - 3.6GB download restarts from zero
3. ⚠️ **Network Type Check** - Downloads on cellular without consent
4. ⚠️ **Tool Confirmations** - UI exists but not wired to ViewModel
5. ⚠️ **Input Validation** - No sanitization on user messages
...
*Generated by Claude Code for LocalAssistant Android app*
