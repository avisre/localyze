...
import com.localassistant.ui.viewmodels.ChatUiState
...
class InputValidationTest {
    ...
    // ═══════════════════════════════════════════════════════
    //  A. Message length validation  –  700 scenarios
    // ═══════════════════════════════════════════════════════
    ...
    private val lengthCategories = listOf(
        ...
        "newline_only" to "\n\n",
        "mixed_whitespace" to "  \t\n  ",
        "unicode_short" to "你好世界",
        "emoji_short" to "🌍🎉📋",
        "arabic_short" to "مرحبا بالعالم"
    )

    /** A1 – 15 lengths × 8 extra checks × 6 edges = 720 */
    @Test
    ...
    // ═══════════════════════════════════════════════════════
    //  B. XSS / Injection pattern validation  –  400 scenarios
    // ═══════════════════════════════════════════════════════
    ...
    /** B1 – 30 XSS patterns × 8 extra checks × 1.7 avg = 408 */
    @Test
    ...
    // ═══════════════════════════════════════════════════════
    //  C. Additional input types  –  300+ scenarios
    // ═══════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════
    //  D. Validation of other input types  –  100+ scenarios
    // ═══════════════════════════════════════════════════════

    /** D1 – Conversation title, memory content, task title, search query, URL validation */
    @Test
    fun d1_otherInputValidations() {
        var count = 0

        // Conversation title tests
        val titles = listOf("", "A", "My Chat", "A".repeat(100), "A".repeat(101), "你好", "<script>")
        for (title in titles) {
    ...
    // ═══════════════════════════════════════════════════════
    //  E. Exact test case from Testing Guide  –  focused scenarios
    // ═══════════════════════════════════════════════════════

    /**
     * E1 – Direct test case from testing guide:
     * Type a very long message (>10,000 chars) → Error snackbar appears, message not sent
     */
    @Test
    fun e1_veryLongMessage_producesError() {
        ...
        // Verify state: error set → message NOT sent
    ...
    /**
     * E2 – Direct test case from testing guide:
     * Paste <script>alert('xss')</script> → Error snackbar appears, message not sent
     */
    @Test
    ...
    /**
     * E3 – Verify sanitization removes dangerous content
     */
    @Test
    ...
    /**
     * E4 – At-limit message should be accepted
     */
    @Test
    ...
    /**
     * E5 – One over limit should be rejected
     */
    @Test
