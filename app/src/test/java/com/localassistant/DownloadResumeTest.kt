...
class DownloadResumeTest {
    ...
    // ═══════════════════════════════════════════════════════
    //  A. Download progress resume logic  –  200+ scenarios
    // ═══════════════════════════════════════════════════════
    ...
    /** A1 – 8 scenarios × 25 extra checks = 200 */
    @Test
        ...
        for (scenario in resumeScenarios) {
            ...
            for (check in listOf("percent_calculation", "range_header", "remaining_bytes",
                ...
                when (check) {
                    ...
                    "restart_vs_resume" -> {
                        // resume=true → continues from saved position
                        // resume=false → deletes temp file and starts fresh
                        val resumeMode = true
    ...
    // ═══════════════════════════════════════════════════════
    //  B. Download progress state model  –  200+ scenarios
    // ═══════════════════════════════════════════════════════
    ...
    /** B1 – 21 percents × 8 errors × 1.2 avg = 200 */
    @Test
    fun b1_downloadProgressStateModel() {
        ...
        assertTrue("Expected ≥180, got $count", count >= 180)
    }
    ...
    /**
     * C1 – Test Case 3: Download Resume
     * Start model download on WiFi → Kill app or disconnect network mid-download
     * → Reopen app → Resume download
    ...
    /**
     * C2 – Verify fresh download starts from 0
     */
    @Test
    ...
    /**
     * C3 – Verify cancellation saves progress
     */
    @Test
    ...
    /**
     * C4 – Verify timeout preserves temp file
     */
    @Test
    ...
    /**
     * C5 – Verify disconnect preserves temp file
     */
    @Test
